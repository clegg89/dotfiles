return {
  {
    ...
    opts = {
      ...
      cmake_compile_commands_options = {
        -- TODO: we'd prefer lsp but cmake-tools doc use a now deprecated call to lspconfig `on_new_config` callback
        -- There are some links saying `root_dir` in lsp.config should be flexible enough to do it but I don't understand
        -- it well enough
